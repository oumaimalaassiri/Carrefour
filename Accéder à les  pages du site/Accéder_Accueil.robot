...
Resource   ../locators/FID_Locators.robot
...
Accéder à la page "Accueil"
  ...
  Click button                        id :GoToFidelitySpace
    Wait Until Page Contains Element  xpath://*[@id="__next"]/div/div[1]/div[2]/nav/a[1]

    Click element  xpath://*[@id="__next"]/div/div[1]/div[2]/nav/a[1]
