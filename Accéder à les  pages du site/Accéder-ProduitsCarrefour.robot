...
*** Test Cases ***
Accéder à la page "Produits Carrefour
   ...
   Wait Until Page Contains Element    Xpath://*[@id="__next"]/div/div[1]/div[2]/nav/a[3]
   Click element                       Xpath://*[@id="__next"]/div/div[1]/div[2]/nav/a[3]
