...
*** Test Cases ***
Accéder à la page de "Mes bons d'achat"
   ...
   Click button   id :mui-3
    ...
    Wait Until Page Contains Element  Xpath://*[@id="__next"]/div/div[2]/div/div[1]/div[2]/div[2]/button

    Click element  Xpath://*[@id="__next"]/div/div[2]/div/div[1]/div[2]/div[2]/button
    sleep  3s
    close browser