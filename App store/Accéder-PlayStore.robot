...
Accéder vers PlayStore
  ...
  Wait Until Page Contains Element    id :GoToFidelitySpace
   ...
   Wait Until Page Contains Element  Xpath://*[@id="__next"]/div/div[3]/div[2]/div[1]/div/div/a
   Click element                      Xpath://*[@id="__next"]/div/div[3]/div[2]/div[1]/div/div/a
   Sleep  3s
