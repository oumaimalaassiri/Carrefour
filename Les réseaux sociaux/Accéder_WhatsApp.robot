 ...
 Accéder vers WhatsApp
  ...
  Wait Until Page Contains Element    id :GoToFidelitySpace
   Click button                       id :GoToFidelitySpace
    ...
    Wait Until Page Contains Element   Xpath://*[@id="__next"]/div/div[3]/div[2]/div[1]/nav[3]/a[2]/div
    Sleep  3s
    Click element                      Xpath://*[@id="__next"]/div/div[3]/div[2]/div[1]/nav[3]/a[2]/div
    sleep  5s
